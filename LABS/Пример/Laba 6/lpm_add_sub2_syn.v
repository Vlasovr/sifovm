...
//lpm_add_sub DEVICE_FAMILY="Stratix II" LPM_DIRECTION="ADD" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="NO" cin cout dataa datab result
...
endmodule //lpm_add_sub2_add_sub
//VALID FILE
...
module lpm_add_sub2 (
	...
	lpm_add_sub2_add_sub	lpm_add_sub2_add_sub_component (
				.dataa (dataa),
				.datab (datab),
				.cin (cin),
				.cout (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub2.tdf TRUE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub2_inst.tdf FALSE
...
// Retrieval info: GEN_FILE: TYPE_NORMAL lpm_add_sub2_syn.v TRUE
