#!/usr/bin/env python3
"""Generate additional detailed PDF drawings for SIFO VM individual task."""
...
def cache(c: canvas.Canvas, tr: Transform) -> None:
    ...
    table_box(c, tr, "Параметры узла", [("k", "4-way"), ("Sets", "16"), ("Line", "1 word"), ("Write", "сквозная"), ("Replacement", "max AGE")], 105, 555, 330)
