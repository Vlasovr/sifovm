...
OUT_DIR = ROOT / "coursework_project" / "report"
...
def main() -> None:
    ...
    p = heading
    inserted = [
        "Вычислительная часть микро-ЭВМ включает 16-разрядное арифметико-логическое устройство, регистровый файл 12 x 16 и регистр флагов FR. Индивидуальное задание требует реализации операций INCS, OR, NOR и SRA; операции ADDC, AND, NOT, ROL и CMP к данному варианту не относятся.",
